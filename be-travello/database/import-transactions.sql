-- ========================================
-- RIWAYAT TRANSAKSI TRAVELLO - IMPORT SQL
-- File ini khusus untuk import data transaksi ke phpMyAdmin
-- ========================================
...
INSERT IGNORE INTO users (
    ...
    'john_doe',
    'john@example.com',
    '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj6ukx.Lf', -- password123
    'user',
    TRUE,
    NOW(),
    NOW()
...
-- Step 11: Insert payment transaction details
...
('txn_005', 'pay_004', 'payment', 843750.00, 'IDR', 'Credit card payment processing', 'CC_1643284567892', 'completed', '2026-01-28 09:15:00', '2026-01-28 09:16:00'),
('txn_006', 'pay_004', 'fee', 24468.75, 'IDR', 'Credit card processing fee (2.9%)', 'FEE_CC_1643284567892', 'completed', '2026-01-28 09:15:00', '2026-01-28 09:16:00'),

('txn_007', 'pay_005', 'payment', 2250000.00, 'IDR', 'E-wallet payment processing', 'EW_1643284567893', 'completed', '2026-01-28 13:45:00', '2026-01-28 13:46:00'),
('txn_008', 'pay_005', 'fee', 33750.00, 'IDR', 'E-wallet processing fee (1.5%)', 'FEE_EW_1643284567893', 'completed', '2026-01-28 13:45:00', '2026-01-28 13:46:00');

-- Step 12: Buat view untuk admin transactions (format khusus admin panel)
...
SELECT * FROM admin_transactions LIMIT 5;
