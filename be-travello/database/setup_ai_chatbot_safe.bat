@echo off
echo =====================================================
echo Safe AI Chatbot Database Setup
echo =====================================================
echo.
...
REM Create database and tables using safe script
echo Creating AI Chatbot database and tables safely...
mysql -h %DB_HOST% -P %DB_PORT% -u %DB_USER% %DB_PASSWORD% < "setup_ai_chatbot_safe.sql"
