...
app.use("/api/auth", authRoutes); // Basic auth routes
app.use("/api/auth", googleAuthRoutes); // Google OAuth routes (same prefix)
...
app.get("/google-auth-test", (req: Request, res: Response) => {
...
app.get("/auto-chat", (req: Request, res: Response) => {
...
app.use((req: Request, res: Response) => {
    res.status(404).json({ 
        ...
        availableRoutes: {
            ...
            "GET /api/auth/config": "Check OAuth configuration",
